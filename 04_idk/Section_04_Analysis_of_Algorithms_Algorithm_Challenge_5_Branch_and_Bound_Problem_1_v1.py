...
def dfs_recursive(list_list_given: List[List[int]],
    ...
    for index_col, value in enumerate(row_current):
        ...
        # TODO JOSEPH WAS TESTING HERE PLS IGNORE
        # # Size same as Matrix size
        # if len(solution_possible) == len(list_list_given):
        #
        #     # If empty list
        #     if not list_solution_possible:
        #         list_solution_possible.append(solution_possible.copy())
        #         # continue
        #
        #     # If new given solution has a smaller min
        #     elif sum(solution_possible) < sum(list_solution_possible[0]):
        #
        #         # Remove the old min
        #         list_solution_possible.pop()
        #
        #         # Add new min
        #         list_solution_possible.append(solution_possible.copy())
        ...
        if len(list_solution_possible) > index_list_solution_possible:
            ...
            list_solution_possible[0] to be able to pass and do another recursive call.
            """
            ...
            if sum_same:
                ...
                Notes:
                    ...
                    set_frozenset_solution = set_frozenset_solution
                        This list is carried over so we can potentially make list_solution_possible to be a
                        list_solution (this variable does not exist, it's more of an idea) and add that to
                        set_frozenset_solution.
                """
                ...
                and add it to set_frozenset_solution.
                """
                ...
                elif sum(list_solution_possible[0]) < sum(list(list(set_frozenset_solution)[0])[0]):
                    set_frozenset_solution.pop()
